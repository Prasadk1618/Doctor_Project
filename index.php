    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img height="10px">DAMS</a>
            </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <form class="form" role="form" method="POST" accept-charset="UTF-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="icPatient"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form"
                                    ...
                                    <input type="number" name="icPatient" value="" class="form-control input-lg"
                                        placeholder="Your IC Number" required />
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                    ...
                    <div class="col-xs-10">
                        <h4>Appointment</h4>
                        <p>Retro chillwave YOLO four loko photo booth. Brooklyn kale chips, seitan hella 3 wolf moon
                            slow-carb paleo.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12 col-xs-12 pad25">
